-- แบบรายงานตัวผู้ประกันตนแรงงานต่างด้าว (ใช้ฟิลด์ชุดเดียวกับแบบขึ้นทะเบียนใน al_data.md)
-- แยกตารางออกจาก alien_insured_doc / alien_insured_person เพราะเป็นเอกสารคนละชุดกัน

CREATE TABLE IF NOT EXISTS alien_insured_checkin_doc (
  ...
  PRIMARY KEY (DocID),
  KEY idx_alien_checkin_doc_date (DocDate),
  KEY idx_alien_checkin_doc_created (CreatedAt)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS alien_insured_checkin_person (
  ...
  KEY idx_alien_checkin_person_doc (DocID),
  KEY idx_alien_checkin_person_sso (SsoCardNo),
  KEY idx_alien_checkin_person_name (FullName),
  CONSTRAINT fk_alien_checkin_person_doc FOREIGN KEY (DocID) REFERENCES alien_insured_checkin_doc (DocID) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
