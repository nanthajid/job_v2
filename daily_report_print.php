...
<head>
  ...
  <title>รายงานการขึ้นทะเบียนว่างงานประจำวัน | สำนักงานจัดหางาน กทม. พื้นที่ 2</title>
...
<div class="wrapper">
  ...
  <!-- Sidebar -->
  <?php $current_page = 'daily_report_print'; include __DIR__ . '/includes/sidebar.php'; ?>
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="col-md-8 px-lg-5">
            <h1 class="gov-page-title">พิมพ์รายงานประจำวัน</h1>
            <p class="mb-0 opacity-9">รายงานรายละเอียดผู้มาขึ้นทะเบียนว่างงานแยกตามช่วงเวลา</p>
          </div>
      ...
      <div class="container-fluid px-lg-5">
        ...
        <div class="report-paper">
          ...
          <div class="doc-footer">
            <span>จำนวนผู้ขึ้นทะเบียนทั้งสิ้น: <?= number_format(count($rows)) ?> ราย</span>
