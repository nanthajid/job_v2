...
$sql = "SELECT
     ...
     FROM kate k
     LEFT JOIN selft_rep s ON s.KNo = k.KNo$where
...
<head>
  <meta charset="UTF-8">
  <title>พิมพ์ตารางสรุปผู้มารายงานตัวว่างงาน</title>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .btn-print { background:#20c997; color:#fff; }
...
<body>
  ...
  <div class="doc-header">
    ...
    <h2>ตารางสรุปผู้มารายงานตัวว่างงาน แยกตามเขตและสาเหตุออกจากงาน</h2>
  ...
  <table class="report">
    ...
    <tfoot>
      ...
      <tr>
        ...
        <td colspan="6" class="total-cell"><?= number_format($grandTotal) ?> ครั้ง</td>
      </tr>
    </tfoot>
  </table>
